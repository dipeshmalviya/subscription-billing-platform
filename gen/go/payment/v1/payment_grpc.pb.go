...
const (
	PaymentService_ChargeCustomer_FullMethodName   = "/payment.v1.PaymentService/ChargeCustomer"
...
func (c *paymentServiceClient) ChargeCustomer(ctx context.Context, in *ChargeCustomerRequest, opts ...grpc.CallOption) (*ChargeCustomerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChargeCustomerResponse)
	err := c.cc.Invoke(ctx, PaymentService_ChargeCustomer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) ChargeCustomer(context.Context, *ChargeCustomerRequest) (*ChargeCustomerResponse, error) {
...
func _PaymentService_ChargeCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChargeCustomerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).ChargeCustomer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_ChargeCustomer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ChargeCustomer(ctx, req.(*ChargeCustomerRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PaymentService_ChargeCustomer_Handler,
		},
		{
